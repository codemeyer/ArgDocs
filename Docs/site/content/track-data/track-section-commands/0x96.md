---
title: "ArgDocs: F1GP Track Section Command 0x96 - Pit Lane Start"
---

# 0x96 - Pit Lane Start (Track Section Command)

This command only occurs once per track, in one of the earlier pit lane sections.
