---
title: "ArgDocs: F1GP Track Section Command 0x9E - Unknown Pit Lane Marker 4"
---

# 0x9E - Unknown Pit Lane Marker 4 (Track Section Command)

This command always occurs _once_ per track, in one of the later pit lane sections,
slightly later than command [0x9D](/argdocs/track-data/track-section-commands/0x9d/).
...
<table class="table table-bordered table-striped table--medium">
    ...
    <tbody>
        <tr>
            <td>0</td>
            <td>Unknown, pit lane end length?</td>
            <td>3 to 17</td>
        </tr>
    </tbody>
</table>
