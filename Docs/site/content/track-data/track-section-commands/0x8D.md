---
title: "ArgDocs: F1GP Track Section Command 0x8C - Changes Unknown Element on the Right?"
---

# 0x8D - Changes Unknown Element on the Right? (Track Section Command)

This command is never used in any of the default tracks.
