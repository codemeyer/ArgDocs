...
<table class="table table-bordered table-striped table--medium">
    ...
    <tbody>
            ...
            <tr>
                ...
                <td class="">Small building with glass area</td>
                <td class=""></td>
            </tr>
            <tr>
                <td style="width: 80px;" class="text-right">23</td>
                <td class="">Bridge over track</td>
                <td class=""></td>
            </tr>
            <tr>
                <td style="width: 80px;" class="text-right">24</td>
                <td class="">Big and tall building</td>
                <td class=""></td>
            </tr>
            <tr>
                <td style="width: 80px;" class="text-right">25</td>
                <td class="">Very long building</td>
                <td class=""></td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td class="">Top of pit building</td>
                <td class=""></td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td class="">Windows on buildings, three tall vertical, bottom slightly smaller</td>
                <td class=""></td>
            </tr>
            <tr>
                <td style="width: 80px;" class="text-right">45</td>
                <td class="">Windows on buildings, three long horizontal, top (and bottom?) slightly thinner</td>
                <td class=""></td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td class="">Windows on buildings, three tall vertical</td>
                <td class=""></td>
            </tr>
            <tr>
                <td style="width: 80px;" class="text-right">51</td>
                <td class="">Windows on buildings, three long horizontal</td>
                <td class=""></td>
            </tr>
    </tbody>
</table>
...
<table class="table table-bordered table-striped table--medium">
    ...
    <tbody>
            <tr>
                <td style="width: 80px;" class="text-right">17</td>
                <td class="">Large building (pit building?)</td>
                <td class=""></td>
            </tr>
            <tr>
                <td style="width: 80px;" class="text-right">18</td>
            ...
            <tr>
                <td style="width: 80px;" class="text-right">20</td>
                <td class="">Small building with windows</td>
                <td class=""></td>
            </tr>
            <tr>
                <td style="width: 80px;" class="text-right">21</td>
            ...
            <tr>
                <td style="width: 80px;" class="text-right">23</td>
                <td class="">Banner/bridge (large pillars) across track</td>
                <td class=""></td>
            </tr>
            <tr>
                <td style="width: 80px;" class="text-right">24</td>
            ...
            <tr>
                <td style="width: 80px;" class="text-right">38</td>
                <td class="">Hill-side? (incl. floating trees)</td>
                <td class=""></td>
            </tr>
            <tr>
                <td style="width: 80px;" class="text-right">39</td>
